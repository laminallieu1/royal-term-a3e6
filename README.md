...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/royal-term-a3e6)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/royal-term-a3e6
```

A live public deployment of this template is available at [https://royal-term-a3e6.templates.workers.dev](https://royal-term-a3e6.templates.workers.dev)
